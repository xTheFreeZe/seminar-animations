...
class Schneiden(ThreeDScene):
    def construct(self):
        ...
        g1_label = MathTex("g_1", color=BLACK).next_to([-1, 0, 2.5], UP, buff=0.2)
        g2_label = MathTex("g_2", color=BLACK).next_to([0, 0.5, -2], DOWN, buff=0.2)
